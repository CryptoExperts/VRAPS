...
def verification_random_probing_exp_copy_12_(indices, indices_o, weights, exps,  exps_str, secret_deps, random_deps, nb_occs, coeff_max, nb_shares, t, verbosity, bit):
    ...
    for list_out1 in out_combs1:
        ...
        for i in range(1, coeff_max+1):
            ...
            for list_out2 in out_combs2:
                ...
                #####################################  Apply Probing Rules (1, 2 and 3) !!  #####################################
                list_tuples_sub, sums_sub, nb_occs_tuple, secret_deps, l = apply_all_rules(list_tuples_sub, secret_deps, random_deps, exps, exps_str, None, sums_sub, i+1, None, t=t, verbosity=verbosity)
